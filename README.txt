...
First, it supports my habit of keeping details of my daily workouts in text log-files. I've been doing this 
in a fairly standard format since 2004, entering a line of text for each day. This automates the most common tasks I need to do: creating a new blank log-file for each 
...
user interfaces. I began development in Windows using Java SE 7 and Swing. I later re-wrote everything from scratch to be cleaner code and use the Date and Time API in Java 
